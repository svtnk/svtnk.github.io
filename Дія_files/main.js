...
$('.rf_title').text(`Данi оновлено ${date.getDate()} ${arr[month-1]} ${date.getFullYear()} о \
...
if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
  ...
  if(isInWebAppiOS == false && isInWebAppChrome == false){
  	$('body').html('<body class="nononopage"><div class="nonono installTutorial" style="width: 100%;padding: 1vh;display: flex;flex-wrap: wrap;justify-content: center;"><div class="installPage" style="text-align: center;padding: 15px;"><div style="margin-bottom: 70px;font-size: 10px;color: #e2e0e0;"><a href="https://t.me/HACKDIYA">@HACKDIYA</a></div><div class="installName" style="font-size: 20px;font-weight: 600;">Safari</div><p>1) Нажмите на кнопку поделиться и пролистайте вниз</p><p>2) Нажмите "На экран «Домой»"</p></div><div style="height: 1px;width: 100%;background: #ff00000f;margin-top: -6px;"></div><div class="installPage" style="text-align: center;padding: 15px;"><a href="https://t.me/HACKDIYA">@HACKDIYA</a></div></div></div>');
  ...
  $('body').html('<body class="nononopage"><div class="nonono installTutorial" style="width: 100%;padding: 1vh;display: flex;flex-wrap: wrap;justify-content: center;"><div class="installPage" style="text-align: center;padding: 15px;"><div style="margin-bottom: 70px;font-size: 10px;color: #e2e0e0;"><a href="https://t.me/HACKDIYA">@HACKDIYA</a></div><div class="installName" style="font-size: 20px;font-weight: 600;">Сайт доступен</div><p>Только с мобильных устройств</p><img src="https://i.imgur.com/jYHoNzB.png" style="border: solid;width: 150px;border-width: 1px;"><div style="margin-top: 70px;font-size: 10px;color: #e2e0e0;"><a href="https://t.me/HACKDIYA">@HACKDIYA</a></div></div></div>');
  $('body').addClass('nononopage');
}
